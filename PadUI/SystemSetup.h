...
#define SYSTEM_TIMER_POWER_SW_TIMER 1

#define SYSTEM_TIMER_PERIPHERALID1 ID_TC1_CHANNEL0
#define SYSTEM_TIMER_PERIPHERALID2 ID_TC1_CHANNEL1

#define POWER_SWITCH_Pin DigitalPin(e_DigitalPortID_A, PIN19_bp)

#define CHARGER_OTG_Pin        DigitalPin(e_DigitalPortID_C, PIN13_bp)
#define CHARGER_CHG_ENABLE_Pin DigitalPin(e_DigitalPortID_D, PIN9_bp)
...
#define SDRAM_BANK0_Pin   DigitalPin(e_DigitalPortID_A, PIN20_bp)
#define SDRAM_BANK1_Pin   DigitalPin(e_DigitalPortID_A, PIN0_bp)
#define SDRAM_CKE_Pin   DigitalPin(e_DigitalPortID_D, PIN14_bp)
#define SDRAM_CLK_Pin   DigitalPin(e_DigitalPortID_D, PIN23_bp)
...
#define QSPI_CE_Pin     DigitalPin(e_DigitalPortID_A, PIN11_bp)
#define QSPI_IO0_Pin    DigitalPin(e_DigitalPortID_A, PIN13_bp)
#define QSPI_IO1_Pin    DigitalPin(e_DigitalPortID_A, PIN12_bp)
#define QSPI_IO2_Pin    DigitalPin(e_DigitalPortID_A, PIN17_bp)
#define QSPI_IO3_Pin    DigitalPin(e_DigitalPortID_D, PIN31_bp)
#define QSPI_RESET_Pin  DigitalPin(e_DigitalPortID_D, PIN24_bp)
#define QSPI_SCK_Pin    DigitalPin(e_DigitalPortID_A, PIN14_bp)


#define WIFI_EN_Pin     DigitalPin(e_DigitalPortID_D, PIN6_bp)
#define WIFI_FLASH_Pin  DigitalPin(e_DigitalPortID_D, PIN4_bp)
#define WIFI_RESET_Pin  DigitalPin(e_DigitalPortID_D, PIN2_bp)
#define WIFI_RX_Pin     DigitalPin(e_DigitalPortID_A, PIN6_bp)
#define WIFI_TX_Pin     DigitalPin(e_DigitalPortID_A, PIN5_bp)

namespace kernel { struct LCDRegisters; }
#define LCD_REGISTERS ((kernel::LCDRegisters*)EBI_CS3_ADDR)
